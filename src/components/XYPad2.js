...
import { changeOSC2Freq } from './actions';
import '../index.css';

class XYPad2 extends React.Component {
  constructor(props) {
  	super(props);
    ...
    updateFrequency(posX, posY) {
      ...
      this.props.changeOSC2Freq(oscFreq);
...
export default connect(mapStateToProps, mapDispatchToProps)(XYPad2);