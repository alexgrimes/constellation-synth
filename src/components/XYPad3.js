...
import { changeOSC3Freq } from './actions';
import '../index.css';

class XYPad3 extends React.Component {
  constructor(props) {
  	super(props);
    ...
    updateCanvas() {
      if (document.getElementsByClassName("canvas 3")) {
    ...
    updateFrequency(posX, posY) {
      ...
      this.props.changeOSC3Freq(oscFreq);
...
export default connect(mapStateToProps, mapDispatchToProps)(XYPad3);